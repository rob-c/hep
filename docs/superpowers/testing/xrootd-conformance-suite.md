...
| `xrootd/xrdproto/frame_conformance_test.go` | Request/response framing: header sizes, `dlen` agreement, the `kXR_writev` exception where segment data sits past the declared payload. |

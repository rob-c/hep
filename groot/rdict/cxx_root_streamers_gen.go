...
func init() {
	...
	StreamerInfos.Add(NewCxxStreamerInfo("TBox", 3, 0x65c15337, []rbytes.StreamerElement{
		...
		&StreamerBasicType{StreamerElement: Element{
			Name:   *rbase.NewNamed("fX1", "X of 1st point"),
			Type:   rmeta.Double,
			Size:   8,
			ArrLen: 0,
			ArrDim: 0,
		...
		&StreamerBasicType{StreamerElement: Element{
			Name:   *rbase.NewNamed("fY1", "Y of 1st point"),
			Type:   rmeta.Double,
			Size:   8,
			ArrLen: 0,
			ArrDim: 0,
		...
		&StreamerBasicType{StreamerElement: Element{
			Name:   *rbase.NewNamed("fX2", "X of 2nd point"),
			Type:   rmeta.Double,
			Size:   8,
			ArrLen: 0,
			ArrDim: 0,
		...
		&StreamerBasicType{StreamerElement: Element{
			Name:   *rbase.NewNamed("fY2", "Y of 2nd point"),
			Type:   rmeta.Double,
			Size:   8,
			ArrLen: 0,
			ArrDim: 0,

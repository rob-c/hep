...
func TestLeafAPI(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			lentype:  1,
			offset:   0,
			kind:     reflect.TypeFor[bool]().Kind(),
		...
		},
		{
			...
			lentype:  1,
			offset:   0,
			kind:     reflect.TypeFor[uint8]().Kind(),
		...
		},
		{
			...
			lentype:  2,
			offset:   0,
			kind:     reflect.TypeFor[uint16]().Kind(),
		...
		},
		{
			...
			lentype:  2,
			offset:   0,
			kind:     reflect.TypeFor[int16]().Kind(),
		...
		},
		{
			...
			lentype:  4,
			offset:   0,
			kind:     reflect.TypeFor[uint32]().Kind(),
		...
		},
		{
			...
			lentype:  4,
			offset:   0,
			kind:     reflect.TypeFor[int32]().Kind(),
		...
		},
		{
			...
			lentype:  8,
			offset:   0,
			kind:     reflect.TypeFor[uint64]().Kind(),
		...
		},
		{
			...
			lentype:  8,
			offset:   0,
			kind:     reflect.TypeFor[int64]().Kind(),
		...
		},
		{
			...
			lentype:  4,
			offset:   0,
			kind:     reflect.TypeFor[float32]().Kind(),
		...
		},
		{
			...
			lentype:  8,
			offset:   0,
			kind:     reflect.TypeFor[float64]().Kind(),
		...
		},
		{
			...
			lentype:  4,
			offset:   0,
			kind:     reflect.TypeFor[root.Float16]().Kind(),
		...
		},
		{
			...
			lentype:  8,
			offset:   0,
			kind:     reflect.TypeFor[root.Double32]().Kind(),
		...
		},
		{
			...
			lentype:  1,
			offset:   0,
			kind:     reflect.TypeFor[string]().Kind(),
